...
const MusicOptions = () => {
  ...
  const { favorites, updateFavorites, addQueue } = useContext(AudioContext);
  ...
  return (
    <div className='music-options-container' style={musicOptionsStyle}>
      <div className='music-options-content'>
        ...
        <div className='options-selection-container'>
          ...
          <div className='bottom-buttons'>
            ...
            >
              <button
                className='download-music-button'
                onClick={closeAllMusicOptions}
              >
...
const MusicInfoBlock = ({ musicOptionsData }) => {
  ...
  const artistImage = artist.replaceAll(" ", "-").toLowerCase();

  return (
    <div className='music-info-block-container'>
      <div className='music-info-block'>
        <img src={`/artists-image/${artistImage}.jpg`} alt='' />
...
const OptionSelection = (props) => {
  ...
  useEffect(
    () => setIsInFavorites(favorites.includes(rawTitle)),
    [favorites, rawTitle, showMusicOptions]
  );
    ...
    <div className='option-selection'>
      ...
      >
        ...
        <div className='option-title'>
          {isInFavorites ? "Remove" : "Add"} to Favorites
        </div>
      </div>
...
const SelectPlaylist = () => {
  ...
  const { musicOptionsData, closeAllMusicOptions } = useContext(EventContext);
