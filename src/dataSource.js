export const bodyData = [
  {
    ...
    musics: [
      "$uicideboy$ - 1000 Blunts.mp3",
      "$uicideboy$ - A Little Trauma Can Be Illuminating, And I'm Shining Like The Sun.mp3",
      "$uicideboy$ - All of My Problems Always Involve Me.mp3",
      "$uicideboy$ - Antarctica.mp3",
      "$uicideboy$ - Are You Going to See the Rose in the Vase, or the Dust on the Table.mp3",
      "$uicideboy$ - Avalon.mp3",
      "$uicideboy$ - Burgundy.mp3",
      "$uicideboy$ - Château Gris.mp3",
      "$uicideboy$ - Coma.mp3",
      "$uicideboy$ - Drag 'Em to the River (Totalitarian Remix).mp3",
      "$uicideboy$ - Either Hated or Ignored.mp3",
      "$uicideboy$ - For the Last Time.mp3",
      "$uicideboy$ - Fucking Your Culture.mp3",
      "$uicideboy$ - Genesis.mp3",
      "$uicideboy$ - Grey Gods.mp3",
      "$uicideboy$ - Harvest Moon.mp3",
      "$uicideboy$ - Hot Razor.mp3",
      "$uicideboy$ - JOAN OF ARC.mp3",
      "$uicideboy$ - Kill Yourself (Part III).mp3",
      "$uicideboy$ - Kill Yourself (Part IV).mp3",
      "$uicideboy$ - Kill Yourself V.mp3",
      "$uicideboy$ - Matte Black.mp3",
      "$uicideboy$ - My Flaws Burn Through My Skin Like Demonic Flames from Hell.mp3",
      "$uicideboy$ - Not Even Ghosts Are This Empty.mp3",
      "$uicideboy$ - Starry 9.mp3",
      "$uicideboy$ - The Light at the End of the Tunnel for $9.99 a Month.mp3",
      "$uicideboy$ - The Thin Grey Line.mp3",
      "$uicideboy$ - Thorns.mp3",
      "$uicideboy$ - Ugliest.mp3",
      "$uicideboy$ - Us Vs. Them.mp3",
    ],
    artistID: 999,
  },
  {
  ...
  {
    path: "bugoy-drilon",
    artistName: "Bugoy Drilon",
    musics: [
      "Bugoy Drilon - Bulag Sa Katotohanan.mp3",
      "Bugoy Drilon - Dahil Tanging Ikaw - Minus One.mp3",
      "Bugoy Drilon - Having You Near Me.mp3",
      "Bugoy Drilon - Hindi Na Bale.mp3",
      "Bugoy Drilon - Muli.mp3",
      "Bugoy Drilon - Nang Dahil Sa Pag Ibig.mp3",
      "Bugoy Drilon - Paano Na Kaya.mp3",
      "Bugoy Drilon - Pagkat Mahal Kita - Minus One.mp3",
      "Bugoy Drilon - Pwede Bang Ako Na Lang Ulit.mp3",
    ],
    artistID: 18,
  },
  {
  ...
  },
  {
    ...
    musics: [
      "Dilaw - Janice.mp3",
      "Dilaw - Orasa.mp3",
      "Dilaw - Sansinukob.mp3",
      "Dilaw - Uhaw (Tayong Lahat).mp3",
    ],
    artistID: 32,
  },
  {
  ...
  {
    path: "juan-karlos",
    artistName: "Juan Karlos",
    musics: [
      "Juan Karlos - Buwan.mp3",
      "Juan Karlos - ERE.mp3",
      "Juan Karlos - Kalawakan.mp3",
      "Juan Karlos - May Halaga Pa Ba Ako Sayo.mp3",
      "Juan Karlos - Para Sayo.mp3",
      "Juan Karlos - Sistema.mp3",
    ],
    artistID: 59,
  },
  {
  ...
  },
  {
    ...
    musics: [
      "Novulent - cursed.mp3",
      "Novulent - enchanting 2.mp3",
      "Novulent - enchanting.mp3",
      "Novulent - euphoria.mp3",
      "Novulent - last dance.mp3",
      "Novulent - last forever.mp3",
      "Novulent - molly and sex.mp3",
      "Novulent - overwhelming.mp3",
      "Novulent - savior.mp3",
      "Novulent - scars.mp3",
      "Novulent - soul ties.mp3",
      "Novulent - unknown feelings.mp3",
      "Novulent - used goods.mp3",
      "Novulent - walking nightmare (feat. greedi).mp3",
    ],
    artistID: 1000,
  },
  {
